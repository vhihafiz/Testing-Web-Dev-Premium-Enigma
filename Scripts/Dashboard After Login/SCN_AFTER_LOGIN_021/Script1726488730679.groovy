...
if(WebUI.verifyElementPresent(findTestObject('Object Repository/After Login/Logout/btn_Close'), 3)) {
	println("Close is exist")
	WebUI.click(findTestObject('Object Repository/After Login/Logout/btn_Close'))
	WebUI.delay(5)
	println("Success click close")
} else {
	println("Close is not exist")
}
