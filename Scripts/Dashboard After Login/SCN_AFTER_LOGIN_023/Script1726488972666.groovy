...
if(WebUI.verifyElementPresent(findTestObject('Object Repository/After Login/Logout/btn_Log Out'), 3)) {
	println("Logout is exist")
	WebUI.click(findTestObject('Object Repository/After Login/Logout/btn_Log Out'))
	WebUI.delay(5)
	println("Success click logout")
} else {
	println("Logout is not exist")
